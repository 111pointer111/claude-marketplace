...
**confidence：** medium
**产出文件：**
  - output/kang_xi/SKILL.md
  - output/kang_xi/README.md
  - output/kang_xi/METADATA.json
  - output/kang_xi/CITATIONS.md
  - output/kang_xi/raw_stats.json
  - output/kang_xi/EVENTS.md
  - output/kang_xi/VOICE.md
